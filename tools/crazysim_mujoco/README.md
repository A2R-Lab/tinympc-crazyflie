...
non-gate challenge objects from rendering and collision; static mode retains
the published ten-object inventory; dynamic mode cycles one of the eight
non-gate objects per event. Position and yaw are interpolated toward
