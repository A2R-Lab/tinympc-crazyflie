...
#define TINYMPC_SITL_MMAP_SLOT_SIZE 320u
#define TINYMPC_SITL_MMAP_RECORD_SIZE 296u
#define TINYMPC_SITL_MMAP_CAPACITY 16384u
#define TINYMPC_SITL_MMAP_FILE_SIZE 5246976u
...
#define TINYMPC_SITL_MMAP_CHECKSUM_OFFSET 312u
#define TINYMPC_SITL_MMAP_RESERVED_OFFSET 316u
