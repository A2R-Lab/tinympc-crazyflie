...
// 1 = fly the precomputed trajectory; 0 = track the commander setpoint (hover).
// Defined in vis_servo_params.c so it's a runtime PARAM (visMpc.enTraj).
extern uint8_t en_traj;
